...
public class TermEndReceiver extends BroadcastReceiver {
    String channelId = "Term End";
    @Override
    public void onReceive(Context context, Intent intent) {
        Toast.makeText(context, intent.getStringExtra("Term End"), Toast.LENGTH_LONG).show();
        createNotificationChannel(context, channelId);
        Notification notification = new NotificationCompat.Builder(context, channelId)
                .setSmallIcon(R.drawable.ic_launcher_foreground)
                .setContentText(intent.getStringExtra("Term End"))
                .setContentTitle("Term Ending").build();
    ...
    private void createNotificationChannel(Context context, String StartChannel){
        CharSequence name = "Term End";
        String description = "Term End Notification.";
